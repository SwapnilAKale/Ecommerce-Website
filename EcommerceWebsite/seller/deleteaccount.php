...
$removeFromCartQuery = "DELETE cart.* FROM cart JOIN product ON cart.product_id = product.product_id WHERE cart.userid = '$user_id'";
mysqli_query($conn, $removeFromCartQuery);

$deleteProductsQuery = "DELETE FROM product WHERE owner = '$user_id'";
